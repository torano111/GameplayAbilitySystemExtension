...
UGASXExperienceDefinition::UGASXExperienceDefinition()
	: Super()
{
...
#if WITH_EDITOR
EDataValidationResult UGASXExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UGASXExperienceDefinition::UpdateAssetBundleData()
{
