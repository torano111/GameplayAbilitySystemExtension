...
public:
	...
	const UGASXPawnData* GetDefaultPawnData() const;
...
template<typename AssetType>
AssetType* UGASXAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
TSubclassOf<AssetType> UGASXAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
