...
#include "GASXGameplayCueManager.generated.h"
...
/**
 * UGASXGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UGASXGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UGASXGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UGASXGameplayCueManager* Get();
